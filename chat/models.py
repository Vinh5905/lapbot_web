...
class LaptopInfo(models.Model):
    ...
    laptop_color = models.CharField(max_length=50, blank=True, null=True)
    ...
    product_id = models.CharField(max_length=50, primary_key=True, db_column='product_id') # Primary key
    ...
    laptop_camera = models.CharField(max_length=50, blank=True, null=True)
